...
public class ModelHWallClingState : PlayerState
{
    #region Fields
    ...
    public override void Attack()
    {
        if (!_isAttacking)
        {
            if (!_model.Weapon.Attack(_view.GroundStandAttackOrigin.position, _view.transform.localScale.x, attackIndex: 3))
                return;
